...
OWN = {
    "tab-group-16": '<path d="M2.5 5.25A1.75 1.75 0 0 1 4.25 3.5h2.4c.46 0 .9.18 1.24.5l.8.79h3.06A1.75 1.75 0 0 1 13.5 6.54v5.2A1.75 1.75 0 0 1 11.75 13.5h-7.5A1.75 1.75 0 0 1 2.5 11.75v-6.5Z" fill="none" stroke="currentColor" stroke-width="1.1" stroke-linejoin="round"/>',
