...
весь экран и F11, защищённое видео (Widevine и PlayReady), блокировка всплывающих окон, поиск по странице, командная
...
«Переводчик» и «Загрузчик видео» на сервисах 190x4, SponsorBlock для YouTube,
автопролистывание Shorts, Reels и TikTok и расширение Twitch (лучшее качество,
бонусы баллов канала, смайлы BTTV и FFZ). Сборка и тесты
