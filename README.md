...
настройки, блокировка рекламы, история, восстановление сессии, поиск по
странице, командная палитра, перевод выделенного и расширение «Загрузчик
видео» на сервисах 190x4. Сборка и тесты идут на Windows-машине разработчика.
