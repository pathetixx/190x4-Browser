  ...
  privacy() {
    ...
    const drmGroup = group(
      [
        ...
        switchSetting(
          "drm_playready",
          "Показывать сайтам и PlayReady",
          "Модуль защиты Microsoft. В браузере он работает хуже Widevine — видео может стоять или идти в плохом качестве, — поэтому без этой настройки сайт получает PlayReady, только когда Widevine для него выключен"
        ),
        switchSetting(
          "drm_fallback",
